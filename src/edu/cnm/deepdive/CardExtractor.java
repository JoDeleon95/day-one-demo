...
public class CardExtractor {
   ...
   * @param args command-line arguments, specifying start end positions.
   */


  public static void main(String[] args) {
    int start = Integer.parseInt(args[0]); // Parse element 0 or args (String) as int.
   ...
   *
   * @param start starting postition (inclusive) of extraction.
